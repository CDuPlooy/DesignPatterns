...
Participants :
      Concrete Factory/Creator (Athos/Aramis/Porthos Constructors) -> Overrides the constructor provided by the abstract Creator.
...
/*
This is an example of the Creator design pattern.
